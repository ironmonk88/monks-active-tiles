...
export class MonksActiveTiles {
        ...
        'exists': {
            ...
            ctrls: [
                ...
                },
                {
                    ...
                    type: "list",
                    onChange: (app, ctrl) => {
                        $('input[name="data.entity"]', app.element).next().html('Current ' + $(ctrl).val());
                    },
                    conditional: (app) => {
    ...
    static async entityName(entity, defaultType) {
        ...
        if (entity?.id == 'tile' || (defaultType == 'tiles' && (entity?.id == undefined || entity?.id == '')))
            ...
            name = (defaultType == 'tokens' || defaultType == undefined ? i18n("MonksActiveTiles.PreviousData") : 'Current ' + defaultType );
